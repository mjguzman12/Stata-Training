...
*Now that the data is imported, you can view it and edit it in many different
*ways. First, take a look at the data pane in the main console. While this was
*originally blank, this now contains a list of variables in your data. Stata
*intuited these from the first row of the file that you just imported. To
*see the actual data that these variables comprise, simply type "browse"
browse
